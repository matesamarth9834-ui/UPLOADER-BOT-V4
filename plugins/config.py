...
class Config(object):
    ...
    API_ID = int(os.environ.get("API_ID", "20246426" ))
    API_HASH = os.environ.get("API_HASH", "77330c674fb1056fa7029a657075d2dc")
    
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    MAX_FILE_SIZE = 1259896345
    TG_MAX_FILE_SIZE = 1259896345
    SESSION_STR = ""
    FREE_USER_MAX_FILE_SIZE = 1259896345
